...
<header class="atelier-header">
		<a class="atelier-header__brand" href="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="Atelier, accueil">atelier<span>.</span><small>forum de connaissances</small></a>
	...
	<form id="atelier-header-search-form" class="atelier-header__search" role="search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" data-atelier-search>
		...
		<input id="atelier-header-search" type="search" name="s" value="<?php echo esc_attr( get_search_query() ); ?>" placeholder="Rechercher dans le forum" autocomplete="off" aria-autocomplete="list" aria-controls="atelier-search-suggestions" aria-expanded="false" />
