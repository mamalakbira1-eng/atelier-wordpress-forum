...
<header class="atelier-header">
        <a class="atelier-header__brand" href="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="atelier. forum de connaissances — accueil">atelier<span>.</span><small>forum de connaissances</small></a>
