...
<form id="new-post" class="atelier-topic-form" name="new-post" method="post" action="<?php the_permalink(); ?>">
	<fieldset class="bbp-form">
		...
		<div class="atelier-topic-form__submit"><p>La publication crée une URL canonique et une archive de discussion publique.</p><button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_topic_submit" name="bbp_topic_submit">Publier la discussion</button></div>
