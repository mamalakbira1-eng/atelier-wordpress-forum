...
<form id="new-post" class="atelier-topic-form" name="new-post" method="post" action="<?php the_permalink(); ?>" enctype="multipart/form-data">
	<fieldset class="bbp-form">
		...
		<div class="atelier-topic-form__step"><span>02</span><label for="bbp_topic_content">Contexte, éléments vérifiables et question</label><small>Indiquez les hypothèses, les sources ou les limites utiles à la lecture.</small><?php bbp_the_content( array( 'context' => 'topic' ) ); ?></div><div class="atelier-media-upload"><label for="atelier_topic_images">Images de la discussion</label><small id="atelier-topic-images-help">Jusqu’à 3 images, 5 Mio chacune. Formats acceptés : JPEG, PNG ou WebP. Quota : 10 images par jour.</small><input type="file" id="atelier_topic_images" name="atelier_topic_images[]" accept="image/jpeg,image/png,image/webp" multiple aria-describedby="atelier-topic-images-help" /></div>
		...
		<?php wp_nonce_field( 'pfc_media_upload', 'pfc_media_nonce' ); ?><?php bbp_topic_form_fields(); ?>
	</fieldset>
</form>
