...
**Référence immuable :** `refs/tags/atelier-prebeta-rc1` une fois le tag publié.
...
| Premium Forum Core | 0.4.18 | `wp-content/plugins/premium-forum-core/` | Métadonnées `premium-forum-core.php`, archive et manifeste. |
...
| Extension | `release/premium-forum-core-0.4.18-import-references.zip` | 28 022 octets | `e08be55140cb117674bdab7247e04aaee89498a4077ed873f013f126325a2ab5` | Import WordPress; racine ZIP `premium-forum-core/`. |
...
| PFC 0.4.18 | Référence installable portant le correctif H01 de validation relationnelle et incluant le correctif H08 de synchronisation bbPress. |
