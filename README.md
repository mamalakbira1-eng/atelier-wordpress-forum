...
Installer bbPress, puis téléverser `release/premium-forum-core-0.3.0.zip` dans Extensions → Ajouter une extension. Téléverser ensuite `release/atelier-0.4.27-initial-author.zip` dans Apparence → Thèmes → Ajouter un thème, puis activer Atelier. Vérifier les permaliens et purger le cache LiteSpeed après activation.
